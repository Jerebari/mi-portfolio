...
export default function Contact() {
  return (
    <section
      id="contact"
      className="px-6 py-16 md:py-20 bg-[#050509] border-t border-zinc-800"
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mt-8 space-y-6">
          <a
            href="mailto:jeremias.barisci@example.com"
            className="inline-flex items-center justify-center rounded-full border border-zinc-700 bg-zinc-900/80 px-5 py-2.5 text-sm font-medium text-zinc-100 hover:border-[#6366f1] hover:text-white hover:bg-zinc-900 transition-colors"
          >
            jeremias.barisci@example.com
          </a>
          ...
          <div className="flex items-center justify-center gap-6">
            <a
              ...
              rel="noreferrer"
              aria-label="LinkedIn"
              className="inline-flex items-center justify-center rounded-full border border-zinc-700 bg-zinc-900/80 p-2.5 text-zinc-200 hover:border-[#6366f1] hover:text-white hover:bg-zinc-900 transition-colors"
            >
              <svg
                className={ICON_SIZE}
                viewBox="0 0 24 24"
